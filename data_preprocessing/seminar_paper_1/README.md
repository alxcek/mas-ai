...
Pipeline u `notebook.ipynb` ukljucuje:

1. Ucitavanje podataka i eksploratorna analiza
2. Predobrada (normalizacija, podela na trening/test skup)
...
6. Uporedna evaluacija (tacnost, F1-score, stopa redukcije, ubrzanje)
...
- **Selekcija instanci:** `imbalanced-learn`
...
- **Metode kondenzacije:** CNN, TomekLinks — fokus na redukciju velicine skupa
